...
| Coordinator directly | This plan, `docs/coordination/REVIEW_PROGRESS.md`, `docs/coordination/PUBLICATION_BACKLOG.md`, maintenance of `docs/coordination/OPERATIONAL_PREMISE_LEDGER.md`, and the RI-21 publication/RI-22 dispatch record. Active QR files are excluded from this coordinator metadata checkpoint. The original review, published synthesis, application corollary and accepted executable sources remain unchanged. |
...
**RI-22 active bounded assignment — scalar independence and composition law**
...
requires separate review. QR owns only the four currently reserved documents.
...
naturality; only appropriate partition maps preserve normalized membership.
