"""QR-05DH Sorkin–Johnston vacuum (BD inverse) driver."""
...
SOURCE_PATHS = ("README.md", "protocol.json", "primary.py", "reference.py",
                "study.py", "test_qr05dh.py")
FIXTURE_PATHS = ()
CAPTURE_SCHEMA = "qr05dh-capture-v1"
FREEZE_SCHEMA = "qr05dh-source-freeze-v1"
...
def _run():
    ...
    primary = load_module("_qr05dh_primary", HERE / "primary.py")
    reference = load_module("_qr05dh_reference", HERE / "reference.py")
...
def main(argv=None):
    parser = argparse.ArgumentParser(description="QR-05DH SJ vacuum (BD inverse)")
