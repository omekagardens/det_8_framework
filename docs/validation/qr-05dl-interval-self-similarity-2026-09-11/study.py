"""QR-05DL interval self-similarity driver."""
...
def _run():
    ...
    primary = load_module("_qr05dl_primary", HERE / "primary.py")
    reference = load_module("_qr05dl_reference", HERE / "reference.py")
...
def main(argv=None):
    parser = argparse.ArgumentParser(description="QR-05DL interval self-similarity")
