"""QR-05CQ adversarial non-manifoldlike control driver."""
...
SOURCE_PATHS = ("README.md", "protocol.json", "primary.py", "reference.py", "study.py", "test_qr05cq.py")
FIXTURE_PATHS = ("../../../det8/models/order_count_geometry.py",)
CAPTURE_SCHEMA = "qr05cq-capture-v1"
FREEZE_SCHEMA = "qr05cq-source-freeze-v1"
...
def analyze_native():
    ...
    primary = load_module("_qr05cq_primary", HERE / "primary.py")
    reference = load_module("_qr05cq_reference", HERE / "reference.py")
...
def main(argv=None):
    parser = argparse.ArgumentParser(description="QR-05CQ adversarial control")
