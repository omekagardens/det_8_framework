"""QR-05DA scale-free LGH convergence driver.
...
def _run():
    ...
    primary = load_module("_qr05da_primary", HERE / "primary.py")
    reference = load_module("_qr05da_reference", HERE / "reference.py")
...
def main(argv=None):
    parser = argparse.ArgumentParser(description="QR-05DA scale-free LGH convergence")
