"""QR-05CC reference-calibration composition verification driver."""
...
SOURCE_PATHS = ("README.md", "protocol.json", "primary.py", "reference.py", "study.py", "test_qr05cc.py")
CAPTURE_SCHEMA = "qr05cc-capture-v1"
FREEZE_SCHEMA = "qr05cc-source-freeze-v1"
...
def analyze_native():
    ...
    primary = load_module("_qr05cc_primary", HERE / "primary.py")
    reference = load_module("_qr05cc_reference", HERE / "reference.py")
...
def main(argv=None):
    parser = argparse.ArgumentParser(description="QR-05CC composition verification")
