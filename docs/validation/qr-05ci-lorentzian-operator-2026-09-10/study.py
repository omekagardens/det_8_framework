"""QR-05CI 2D Lorentzian operator benchmark driver."""
...
SOURCE_PATHS = ("README.md", "protocol.json", "primary.py", "reference.py", "study.py", "test_qr05ci.py")
FIXTURE_PATHS = ("../../../det8/models/order_count_geometry.py",)
CAPTURE_SCHEMA = "qr05ci-capture-v1"
FREEZE_SCHEMA = "qr05ci-source-freeze-v1"
...
def analyze_native():
    ...
    primary = load_module("_qr05ci_primary", HERE / "primary.py")
    reference = load_module("_qr05ci_reference", HERE / "reference.py")
...
def main(argv=None):
    parser = argparse.ArgumentParser(description="QR-05CI 2D Lorentzian operator benchmark")
