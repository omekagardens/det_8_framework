"""QR-05DC max-plus closure driver.
...
SOURCE_PATHS = ("README.md", "protocol.json", "primary.py", "reference.py",
                "study.py", "test_qr05dc.py")
FIXTURE_PATHS = ("../../../det8/models/order_count_geometry.py",)
CAPTURE_SCHEMA = "qr05dc-capture-v1"
FREEZE_SCHEMA = "qr05dc-source-freeze-v1"
...
def _run():
    ...
    primary = load_module("_qr05dc_primary", HERE / "primary.py")
    reference = load_module("_qr05dc_reference", HERE / "reference.py")
...
def main(argv=None):
    parser = argparse.ArgumentParser(description="QR-05DC max-plus closure")
