"""QR-05CU Minguzzi-Suhr LGH distance attempt driver."""
...
SOURCE_PATHS = ("README.md", "protocol.json", "primary.py", "reference.py", "study.py", "test_qr05cu.py")
FIXTURE_PATHS = ("../../../det8/models/order_count_geometry.py",)
CAPTURE_SCHEMA = "qr05cu-capture-v1"
FREEZE_SCHEMA = "qr05cu-source-freeze-v1"
...
def analyze_native():
    ...
    primary = load_module("_qr05cu_primary", HERE / "primary.py")
    reference = load_module("_qr05cu_reference", HERE / "reference.py")
...
def main(argv=None):
    parser = argparse.ArgumentParser(description="QR-05CU LGH distance attempt")
