"""QR-05DM stronger-adversary driver."""
...
SOURCE_PATHS = ("README.md", "protocol.json", "primary.py", "reference.py",
                "study.py", "test_qr05dm.py")
FIXTURE_PATHS = ()
CAPTURE_SCHEMA = "qr05dm-capture-v1"
FREEZE_SCHEMA = "qr05dm-source-freeze-v1"
...
def _run():
    ...
    primary = load_module("_qr05dm_primary", HERE / "primary.py")
    reference = load_module("_qr05dm_reference", HERE / "reference.py")
...
def main(argv=None):
    parser = argparse.ArgumentParser(description="QR-05DM stronger adversary")
