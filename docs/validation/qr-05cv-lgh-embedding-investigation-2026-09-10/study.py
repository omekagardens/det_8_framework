"""QR-05CV LGH/embedding investigation (exact LMS core) driver."""
...
SOURCE_PATHS = ("README.md", "protocol.json", "primary.py", "reference.py", "study.py", "test_qr05cv.py")
FIXTURE_PATHS = ("../../../det8/models/order_count_geometry.py",)
CAPTURE_SCHEMA = "qr05cv-capture-v1"
FREEZE_SCHEMA = "qr05cv-source-freeze-v1"
...
def analyze_native():
    ...
    primary = load_module("_qr05cv_primary", HERE / "primary.py")
    reference = load_module("_qr05cv_reference", HERE / "reference.py")
...
def main(argv=None):
    parser = argparse.ArgumentParser(description="QR-05CV LGH/embedding investigation")
