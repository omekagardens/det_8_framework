"""QR-05CW LGH infimum via bottleneck assignment driver."""
...
SOURCE_PATHS = ("README.md", "protocol.json", "primary.py", "reference.py", "study.py", "test_qr05cw.py")
FIXTURE_PATHS = ("../../../det8/models/order_count_geometry.py",)
CAPTURE_SCHEMA = "qr05cw-capture-v1"
FREEZE_SCHEMA = "qr05cw-source-freeze-v1"
...
def analyze_native():
    ...
    primary = load_module("_qr05cw_primary", HERE / "primary.py")
    reference = load_module("_qr05cw_reference", HERE / "reference.py")
...
def main(argv=None):
    parser = argparse.ArgumentParser(description="QR-05CW LGH infimum")
