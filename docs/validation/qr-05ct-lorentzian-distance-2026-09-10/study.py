"""QR-05CT Lorentzian-distance continuum step driver."""
...
SOURCE_PATHS = ("README.md", "protocol.json", "primary.py", "reference.py", "study.py", "test_qr05ct.py")
FIXTURE_PATHS = ("../../../det8/models/order_count_geometry.py",)
CAPTURE_SCHEMA = "qr05ct-capture-v1"
FREEZE_SCHEMA = "qr05ct-source-freeze-v1"
...
def analyze_native():
    ...
    primary = load_module("_qr05ct_primary", HERE / "primary.py")
    reference = load_module("_qr05ct_reference", HERE / "reference.py")
...
def main(argv=None):
    parser = argparse.ArgumentParser(description="QR-05CT Lorentzian-distance step")
