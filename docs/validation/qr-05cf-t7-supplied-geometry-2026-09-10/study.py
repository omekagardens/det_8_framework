"""QR-05CF T7 supplied-geometry benchmark driver."""
...
SOURCE_PATHS = ("README.md", "protocol.json", "primary.py", "reference.py", "study.py", "test_qr05cf.py")
FIXTURE_PATHS = ("../../../det8/models/order_count_geometry.py",)
CAPTURE_SCHEMA = "qr05cf-capture-v1"
FREEZE_SCHEMA = "qr05cf-source-freeze-v1"
...
def analyze_native():
    ...
    primary = load_module("_qr05cf_primary", HERE / "primary.py")
    reference = load_module("_qr05cf_reference", HERE / "reference.py")
...
def main(argv=None):
    parser = argparse.ArgumentParser(description="QR-05CF T7 supplied-geometry benchmark")
