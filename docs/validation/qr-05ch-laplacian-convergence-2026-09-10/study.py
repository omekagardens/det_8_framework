"""QR-05CH graph-Laplacian convergence benchmark driver."""
...
SOURCE_PATHS = ("README.md", "protocol.json", "primary.py", "reference.py", "study.py", "test_qr05ch.py")
CAPTURE_SCHEMA = "qr05ch-capture-v1"
FREEZE_SCHEMA = "qr05ch-source-freeze-v1"
...
def analyze_native():
    ...
    primary = load_module("_qr05ch_primary", HERE / "primary.py")
    reference = load_module("_qr05ch_reference", HERE / "reference.py")
...
def main(argv=None):
    parser = argparse.ArgumentParser(description="QR-05CH graph-Laplacian benchmark")
