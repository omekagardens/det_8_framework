"""QR-05CG dimension-convergence benchmark driver."""
...
SOURCE_PATHS = ("README.md", "protocol.json", "primary.py", "reference.py", "study.py", "test_qr05cg.py")
FIXTURE_PATHS = ("../../../det8/models/order_count_geometry.py",)
CAPTURE_SCHEMA = "qr05cg-capture-v1"
FREEZE_SCHEMA = "qr05cg-source-freeze-v1"
...
def analyze_native():
    ...
    primary = load_module("_qr05cg_primary", HERE / "primary.py")
    reference = load_module("_qr05cg_reference", HERE / "reference.py")
...
def main(argv=None):
    parser = argparse.ArgumentParser(description="QR-05CG dimension-convergence benchmark")
