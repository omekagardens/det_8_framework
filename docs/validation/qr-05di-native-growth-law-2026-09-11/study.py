"""QR-05DI native growth law driver."""
...
SOURCE_PATHS = ("README.md", "protocol.json", "primary.py", "reference.py",
                "study.py", "test_qr05di.py")
FIXTURE_PATHS = ()
CAPTURE_SCHEMA = "qr05di-capture-v1"
FREEZE_SCHEMA = "qr05di-source-freeze-v1"
...
def _run():
    ...
    primary = load_module("_qr05di_primary", HERE / "primary.py")
    reference = load_module("_qr05di_reference", HERE / "reference.py")
...
def main(argv=None):
    parser = argparse.ArgumentParser(description="QR-05DI native growth law")
