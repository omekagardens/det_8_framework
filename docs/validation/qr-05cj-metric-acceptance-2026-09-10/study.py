"""QR-05CJ metric-acceptance benchmark driver."""
...
SOURCE_PATHS = ("README.md", "protocol.json", "primary.py", "reference.py", "study.py", "test_qr05cj.py")
CAPTURE_SCHEMA = "qr05cj-capture-v1"
FREEZE_SCHEMA = "qr05cj-source-freeze-v1"
...
def analyze_native():
    ...
    primary = load_module("_qr05cj_primary", HERE / "primary.py")
    reference = load_module("_qr05cj_reference", HERE / "reference.py")
...
def main(argv=None):
    parser = argparse.ArgumentParser(description="QR-05CJ metric-acceptance benchmark")
