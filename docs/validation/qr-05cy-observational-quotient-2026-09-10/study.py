"""QR-05CY observational quotient and internal-reference no-go driver."""
...
SOURCE_PATHS = ("README.md", "protocol.json", "primary.py", "reference.py", "study.py", "test_qr05cy.py")
FIXTURE_PATHS = ("../../../det8/models/order_count_geometry.py", "../../../det8/claims.py")
CAPTURE_SCHEMA = "qr05cy-capture-v1"
FREEZE_SCHEMA = "qr05cy-source-freeze-v1"
...
def analyze_native():
    ...
    primary = load_module("_qr05cy_primary", HERE / "primary.py")
    reference = load_module("_qr05cy_reference", HERE / "reference.py")
...
def main(argv=None):
    parser = argparse.ArgumentParser(description="QR-05CY observational quotient")
