"""QR-05CR no-double-counting audit driver."""
...
SOURCE_PATHS = ("README.md", "protocol.json", "primary.py", "reference.py", "study.py", "test_qr05cr.py")
CAPTURE_SCHEMA = "qr05cr-capture-v1"
FREEZE_SCHEMA = "qr05cr-source-freeze-v1"
...
def analyze_native():
    ...
    primary = load_module("_qr05cr_primary", HERE / "primary.py")
    reference = load_module("_qr05cr_reference", HERE / "reference.py")
...
def main(argv=None):
    parser = argparse.ArgumentParser(description="QR-05CR no-double-counting audit")
