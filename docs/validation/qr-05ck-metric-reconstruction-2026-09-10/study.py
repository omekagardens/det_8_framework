"""QR-05CK metric reconstruction / refinement benchmark driver."""
...
SOURCE_PATHS = ("README.md", "protocol.json", "primary.py", "reference.py", "study.py", "test_qr05ck.py")
CAPTURE_SCHEMA = "qr05ck-capture-v1"
FREEZE_SCHEMA = "qr05ck-source-freeze-v1"
...
def analyze_native():
    ...
    primary = load_module("_qr05ck_primary", HERE / "primary.py")
    reference = load_module("_qr05ck_reference", HERE / "reference.py")
...
def main(argv=None):
    parser = argparse.ArgumentParser(description="QR-05CK metric reconstruction benchmark")
