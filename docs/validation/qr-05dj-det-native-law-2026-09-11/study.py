"""QR-05DJ DET-native law map driver."""
...
SOURCE_PATHS = ("README.md", "protocol.json", "primary.py", "reference.py",
                "study.py", "test_qr05dj.py")
FIXTURE_PATHS = ()
CAPTURE_SCHEMA = "qr05dj-capture-v1"
FREEZE_SCHEMA = "qr05dj-source-freeze-v1"
...
def _run():
    ...
    primary = load_module("_qr05dj_primary", HERE / "primary.py")
    reference = load_module("_qr05dj_reference", HERE / "reference.py")
...
def main(argv=None):
    parser = argparse.ArgumentParser(description="QR-05DJ DET-native law map")
