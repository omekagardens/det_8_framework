"""QR-05CZ scale-free LGH comparison and directed-distance correction driver."""
...
SOURCE_PATHS = ("README.md", "protocol.json", "primary.py", "reference.py", "study.py", "test_qr05cz.py")
FIXTURE_PATHS = ("../../../det8/models/order_count_geometry.py",)
CAPTURE_SCHEMA = "qr05cz-capture-v1"
FREEZE_SCHEMA = "qr05cz-source-freeze-v1"
...
def analyze_native():
    ...
    primary = load_module("_qr05cz_primary", HERE / "primary.py")
    reference = load_module("_qr05cz_reference", HERE / "reference.py")
...
def main(argv=None):
    parser = argparse.ArgumentParser(description="QR-05CZ scale-free LGH comparison")
