"""QR-05CM T5 drift-diffusion / variable-coefficient benchmark driver."""
...
SOURCE_PATHS = ("README.md", "protocol.json", "primary.py", "reference.py", "study.py", "test_qr05cm.py")
CAPTURE_SCHEMA = "qr05cm-capture-v1"
FREEZE_SCHEMA = "qr05cm-source-freeze-v1"
...
def analyze_native():
    ...
    primary = load_module("_qr05cm_primary", HERE / "primary.py")
    reference = load_module("_qr05cm_reference", HERE / "reference.py")
...
def main(argv=None):
    parser = argparse.ArgumentParser(description="QR-05CM T5 drift-diffusion benchmark")
