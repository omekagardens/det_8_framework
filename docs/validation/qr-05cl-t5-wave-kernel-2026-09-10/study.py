"""QR-05CL T5 local-kernel continuum (wave-like) benchmark driver."""
...
SOURCE_PATHS = ("README.md", "protocol.json", "primary.py", "reference.py", "study.py", "test_qr05cl.py")
CAPTURE_SCHEMA = "qr05cl-capture-v1"
FREEZE_SCHEMA = "qr05cl-source-freeze-v1"
...
def analyze_native():
    ...
    primary = load_module("_qr05cl_primary", HERE / "primary.py")
    reference = load_module("_qr05cl_reference", HERE / "reference.py")
...
def main(argv=None):
    parser = argparse.ArgumentParser(description="QR-05CL T5 wave-kernel benchmark")
