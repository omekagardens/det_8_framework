"""QR-05CO scale-consistency witness driver."""
...
SOURCE_PATHS = ("README.md", "protocol.json", "primary.py", "reference.py", "study.py", "test_qr05co.py")
CAPTURE_SCHEMA = "qr05co-capture-v1"
FREEZE_SCHEMA = "qr05co-source-freeze-v1"
...
def analyze_native():
    ...
    primary = load_module("_qr05co_primary", HERE / "primary.py")
    reference = load_module("_qr05co_reference", HERE / "reference.py")
...
def main(argv=None):
    parser = argparse.ArgumentParser(description="QR-05CO scale-consistency witness")
