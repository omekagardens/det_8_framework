...
SOURCE_PATHS = ("README.md", "protocol.json", "primary.py", "reference.py",
                "study.py", "test_qr05dn.py")
FIXTURE_PATHS = ("../../../det8/claims.py",)
CAPTURE_SCHEMA = "qr05dn-capture-v1"
FREEZE_SCHEMA = "qr05dn-source-freeze-v1"
...
def _run():
    ...
    primary = load_module("_qr05dn_primary", HERE / "primary.py")
    reference = load_module("_qr05dn_reference", HERE / "reference.py")
...
def main(argv=None):
    parser = argparse.ArgumentParser(description="QR-05DN governed T7 link")
