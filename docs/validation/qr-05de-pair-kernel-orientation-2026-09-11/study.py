"""QR-05DE pair-kernel orientation driver.
...
SOURCE_PATHS = ("README.md", "protocol.json", "primary.py", "reference.py",
                "study.py", "test_qr05de.py")
FIXTURE_PATHS = ()
CAPTURE_SCHEMA = "qr05de-capture-v1"
FREEZE_SCHEMA = "qr05de-source-freeze-v1"
...
def _run():
    ...
    primary = load_module("_qr05de_primary", HERE / "primary.py")
    reference = load_module("_qr05de_reference", HERE / "reference.py")
...
def main(argv=None):
    parser = argparse.ArgumentParser(description="QR-05DE pair-kernel orientation")
