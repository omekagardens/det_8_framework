"""Independent reference route for QR-05DK.

Same report by different mechanics: light-cone causality; transitive percolation and the
2-layer bipartite order recoded (same RNG streams); statistics and the report recoded.
"""
...
def build_report(protocol):
    module = load_module("_qr05dk_t7_ref", MODULE_PATH)
    n = protocol["n"]
    seed = protocol["seed"]
