"""QR-05CN T7/T5 compatibility bridge witness driver."""
...
SOURCE_PATHS = ("README.md", "protocol.json", "primary.py", "reference.py", "study.py", "test_qr05cn.py")
CAPTURE_SCHEMA = "qr05cn-capture-v1"
FREEZE_SCHEMA = "qr05cn-source-freeze-v1"
...
def analyze_native():
    ...
    primary = load_module("_qr05cn_primary", HERE / "primary.py")
    reference = load_module("_qr05cn_reference", HERE / "reference.py")
...
def main(argv=None):
    parser = argparse.ArgumentParser(description="QR-05CN T7/T5 compatibility witness")
