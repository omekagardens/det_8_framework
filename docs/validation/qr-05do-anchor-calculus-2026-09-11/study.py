"""QR-05DO anchor-calculus driver."""
...
SOURCE_PATHS = ("README.md", "protocol.json", "primary.py", "reference.py",
                "study.py", "test_qr05do.py")
FIXTURE_PATHS = ("../qr-05cy-observational-quotient-2026-09-10/primary.py",
                 "../../../det8/models/order_count_geometry.py")
CAPTURE_SCHEMA = "qr05do-capture-v1"
FREEZE_SCHEMA = "qr05do-source-freeze-v1"
...
def _run():
    ...
    primary = load_module("_qr05do_primary", HERE / "primary.py")
    reference = load_module("_qr05do_reference", HERE / "reference.py")
...
def main(argv=None):
    parser = argparse.ArgumentParser(description="QR-05DO anchor calculus")
