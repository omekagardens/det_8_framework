"""QR-05DG Sorkin–Johnston-structured pair-kernel driver."""
...
SOURCE_PATHS = ("README.md", "protocol.json", "primary.py", "reference.py",
                "study.py", "test_qr05dg.py")
FIXTURE_PATHS = ()
CAPTURE_SCHEMA = "qr05dg-capture-v1"
FREEZE_SCHEMA = "qr05dg-source-freeze-v1"
...
def _run():
    ...
    primary = load_module("_qr05dg_primary", HERE / "primary.py")
    reference = load_module("_qr05dg_reference", HERE / "reference.py")
...
def main(argv=None):
    parser = argparse.ArgumentParser(description="QR-05DG Sorkin–Johnston pair-kernel")
