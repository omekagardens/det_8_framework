...
With DD the scale-free convergence question has a favourable **bounded 1+1 numerical**
answer for the order-only reconstruction (not a theorem). What remains on Branch A is (i) an unconditional proof of the uniform
