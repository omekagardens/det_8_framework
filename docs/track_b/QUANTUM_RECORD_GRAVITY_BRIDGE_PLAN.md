...
fraction alone is insufficient. The open question is a **higher-order manifoldlike
invariant** (interval structure + covariance) with a provenance-independent bound. With DD the scale-free
