...
|---|---|---|
| RI-71 operator covariance design | **Published in independently verified `ebfd0ec`.** | RI-73 source is published; actual conditional qualification awaits runtime/custody recovery. |
| RI-70 native height tradeoff | **Published in independently verified `ebfd0ec`.** | Preserve endpoints; RI-72 is published and RI-74 is under final review. |
