...
| Document | Content |
|---|---|
| [`MODEL_CARD.md`](MODEL_CARD.md) | **Primary reference.** Primitives, 10 active + 5 retired correspondence checks, 1 prediction, 83 code modules, formulas, test suite. |
...
- **230/230 tests passing** — `python3 run_tests.py`
...
- **83 code modules** — event graph, records, bonds, κ-diffusion, time evolution, unified simulation, experimental simulators
