...
## 2. Four Deadlocks Resolved

### 2.1 Time: Block Universe → Record-Growth Time
...
### 2.2 Quantum: Many-Worlds → Open Relational Constraints
...
### 2.3 Agency: Epiphenomenalism/Dualism → Present-Enactment Agency
...
### 2.4 History: Retrocausality → Mutable Structural Carrying (κ)
